...
pub async fn get_show_admin(fetch: &State<Fetch>, db: Db, _admin: UserInClaims, id: i32) -> Result<Json<SlideExpanded>, Status> {
...
pub async fn get_multiple_admin(fetch: &State<Fetch>, db: &Db, _admin: UserInClaims, ids: Vec<i32>) -> Result<Json<Vec<SlideExpanded>>, Status> {
